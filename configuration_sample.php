...
$csrfKeyFile = __DIR__.'/private/csrf.key';

if (!is_readable($csrfKeyFile)) {
    throw new RuntimeException('Missing readable private/csrf.key.');
}

$csrfKey = trim((string) file_get_contents($csrfKeyFile));
$appName = (string) ($_SERVER['FILEGATOR_APP_NAME'] ?? 'FileGator');

if (!preg_match('/^[A-Fa-f0-9]{64}$/D', $csrfKey)) {
    throw new RuntimeException('Invalid private/csrf.key.');
}
...
return [
    ...
    'lockout_timeout' => 900, // 15 minutes after repeated login failures
    ...
    'frontend_config' => [
        ...
        'public_file_extensions' => ['.jpg', '.jpeg', '.png', '.gif', '.pdf'],
        'upload_max_size' => 100 * 1024 * 1024, // 100MB
        'upload_chunk_size' => 1 * 1024 * 1024, // 1MB
        'upload_simultaneous' => 3,
        'default_archive_name' => 'archive.zip',
        'editable' => [], // this portal is for file publishing, not in-browser source editing
